 ...
 * The BITBURST Developers 201-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("BITBURST") + " - " + tr("Wallet"));
#ifndef Q_WS_MAC
 ...
 centralWidget->setStyleSheet("QWidget { background-color: rgb(229, 229, 229); }");
...
frameBlocks->setStyleSheet("QWidget { background-color: rgb(95, 95, 95);}");
...
statusBar()->setStyleSheet("QWidget { background-color: rgb(95, 95, 95); }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BITBURST address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BITBURST"), this);
    aboutAction->setToolTip(tr("Show information about BITBURST"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for BITBURST"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("Show/Hide &BITBURST"), this);
    toggleHideAction->setToolTip(tr("Show or hide the BITBURST window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BITBURST client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BITBURST client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide BITBURST"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BITBURST network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BITBURST address or malformed URI parameters."));
    }
