...
// Copyright (c) 2013 BITBURST Developers
...
uint256 hashGenesisBlock("0x9ec3a13c0e69d93e76d89ce2d922768ec4b42347365d69cdaa98851b1c4568f9");

static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BITBURST: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BITBURST Signed Message:\n";
...
int64  GetBlockValue(int nHeight, int64 nFees) {
	int64 nSubsidy = 0.0035 * COIN;

   if(nHeight == 1) {
      //this is pre-mining, reward is 0.34984
	   nSubsidy = 399.9985 * COIN;
...
static const int64 nTargetTimespan =  120; // 60 seconds
static const int64 nTargetSpacing = 120; // 60 seconds
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
static const int64 nTargetTimespanRe = 120;  // 120 seconds
static const int64 nTargetSpacingRe = 120; // 120 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
   ...
   if(fNewDifficultyProtocol) {
    ...
    // BITBURST: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal BITBURST miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BITBURST", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x90447a710ae58709a70dcaf1b4f5a62d771f4404252535f6295eb6f89af1ef2d");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Un bitburst per domarli, un bitbirst per trovarli e nel buio incatenarli";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
		block.nTime = 1402071468;
        block.nBits    = 0x1e0ffff0;
		block.nNonce = 1937681;
		
        if (fTestNet)
        {
			block.nTime = 1402071268;
			block.nNonce = 1660034;
        }
        ...
        assert(block.hashMerkleRoot == uint256("7f9c872a313af8df461eee6d763b2d45ac66472a372de6afb816e4bc524af45b"));
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xb6, 0xda };
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // BITBURSTd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
